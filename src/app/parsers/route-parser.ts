...
export class RouteParser {
	...
	private routes: any[] = [
		...
		{ code: 37161004, epic: 17, display: 'rectal route', synonyms: ['rectally', 'p\\.r\\.\\b', 'pr\\b'] },
		{ code: 78421000, epic: 6, display: 'intramuscular route', synonyms: ['i\\.m\\.\\b', '\\bim\\b', 'intramuscular' ] },
		...
		{ code: 45890007, epic: 20, display: 'transdermal route', synonyms: ['transdermally'] },
		{ code: 417985001, display: 'enteral route', synonyms: ['enterally'] },
		{ code: 127490009, epic: 86, display: 'gastrostomy route', synonyms: ['via g(?:-| )?tube'] },
		{ code: 127491008, epic: 89, display: 'jejunostomy route', synonyms: ['via j(?:-| )?tube'] },
